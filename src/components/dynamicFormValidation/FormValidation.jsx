...
function FormValidation() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const validateErrors = validateForms();
        setFormData(validateErrors);
  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                <label>Contact:</label>
                <input type='tel' name='contact' placeholder='Enter Contact' value={formData.contact} onChange={handleChange} />
